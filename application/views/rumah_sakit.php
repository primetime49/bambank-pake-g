...
<section class="section-header">
  <div class="jumbotron jumbotron-fluid jumbo">
    <a href="<?= site_url('') ?>" style="margin-left: 40px; margin-top: -35px; float: left; color: white">Home > Rumah Sakit </a>
    ...
    <img src="https://www.pngkey.com/png/full/357-3572177_hospital-white-noshadowai-icon.png" style="float: right; height:250px; width:300px; margin-right: 250px; margin-top: -20px">
  </div>
</section>
